			...
			<div class="row">
				<div class="col-md-12">
					<ul class="nav nav-tabs">
						...
						<li class="active"><a href='ThingsOutsideRoom.php'>Out Side Room Things</a>
						</li>
					</ul>
					<!--tab content start-->
					<div class="tab-content" id="tab-content">
                        						...
                        						<div class='card-body'>
                          							<table id='bootstrap-data-table' class='table table-striped table-bordered'>
							                            ...
							                            <tbody>";
	                          								...
	                          								{
	                          									echo "<tr>
										                                <th>".$ThingsInBuildingData_object->BuildingData_object->NAME."</th>
										                                <th>".$ThingsInBuildingData_object->ThingData_object->NAME."</th>
										                              </tr>";
	                          								}
                		...
                		<div class='row text-center'>
                			<form method='post' action='PDFReport/ThingsOutsideRoomReportGenerate.php'>
