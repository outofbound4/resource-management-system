			...
			<div class="row">
				<div class="col-md-12">
					<ul class="nav nav-tabs">
						<li class="active"><a data-toggle="tab" onclick="buildingMaintananceInterface()">Building Maintanance</a>
						</li>
						<li class=""><a data-toggle="tab" onclick="thingMaintananceInterface()">Thing Maintanance</a>
						</li>
...
<script src="js/maintanance.js"></script>
<script type="text/javascript">(function(){buildingMaintananceInterface();}());</script>
<?php
