			...
			<div class="row">
				<div class="col-md-12">
					<ul class="nav nav-tabs">
						...
						<li class="active"><a href='RoomThingsReport.php'>Room Things</a>
						</li>
					...
					<div class="tab-content" id="tab-content">
                        						...
                        						<div class='card-body'>
                          							<table id='bootstrap-data-table' class='table table-striped table-bordered'>
							                            ...
							                            <tbody>";
	                          								...
	                          								{
	                          									echo "<tr>
										                                <th>".$ThingsInRoomData_object->RoomData_object->BuildingData_object->NAME."</th>
										                                <th>".$ThingsInRoomData_object->RoomData_object->NAME."</th>
										                                <th>".$ThingsInRoomData_object->ThingData_object->NAME."</th>
										                              </tr>";
	                          								}
                		...
                		<div class='row text-center'>
                			<form method='post' action='PDFReport/RoomThingsReportGenerate.php'>
	                			<button class='btn btn-success' onclick=""><span class='fa fa-download'></span>&nbsp Generate</button>
	                		</form>
                		</div>
