			...
			<div class="row">
				<div class="col-md-12">
					<ul class="nav nav-tabs">
						<li class="active"><a href ='ThingMaintananceReport.php'>Thing Maintanance</a>
						</li>
					...
					<div class="tab-content" id="tab-content">
                        						...
                        						<div class='card-body'>
                          							<table id='bootstrap-data-table' class='table table-striped table-bordered'>
							                            ...
							                            <tbody>";
	                          								...
	                          								{
	                          									echo "<tr>
										                                <th>".$ThingMaintananceData_object->ID."</th>
										                                <th>".$ThingMaintananceData_object->ThingData_object->NAME."</th>
										                                <th>".$ThingMaintananceData_object->NAME."</th>
										                                <th>".$ThingMaintananceData_object->COST."</th>
										                              </tr>";
	                          								}
                		...
                		<div class='row text-center'>
                			<form method='post' action='PDFReport/ThingMaintananceReportGenerate.php'>
