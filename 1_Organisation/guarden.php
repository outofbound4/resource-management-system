		...
		<nav class="navbar-default navbar-side" role="navigation" >
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li>
						<a href="Class.php"><i class="fa fa-edit "></i></i>Class</a>
					</li>
					<li>
                		<a href="Department.php"><i class="fa fa-edit "></i></i>Department</a>
            		</li>
					<li>
			...
			<div class="row">
				<div class="col-md-12">
					<ul class="nav nav-tabs">
						<li class="active"><a data-toggle="tab" onclick="addGuardenInterface()">Add Guarden</a>
						</li>
						<li class=""><a data-toggle="tab" onclick="addPlantInterface()">Add Plant</a>
						</li>
...
<script src="js/guarden.js"></script>
<script type="text/javascript">(function(){addGuardenInterface();}());</script>
<?php
