        ...
        function validate(form_id,email)
        {
        	if(!Empty_check(form_id))
        	{
        		if(ValidateEmail(email))
        		{
            		...
            		ajax_obj.processPOST("ajax_server/login.php", POST_AJAX_validate, url);
        		}
        		else
        			alert("Invalid Email !");
        	}
                ...
                <div class="row col-md-offset-3">
                    <div class="col-lg-6 col-md-6">
                        <div class="div-trans text-center">
                        	<br/>
                            <h4>Please enter registered Email</h4>
                            <br>
                            <br>
                            ...
                            <form class="form-signin" method="post" role="form" id='formid'>
                                ...
                                <br>
                                <div class="form-group">
                                    <button type="button" class="btn btn-primary btn-block" onclick="validate('formid','email');" value='submit'>Submit</button>
                                </div>
                                <h4><a href='index.php'><button type='button' value='bbb'>Back</button></a></h4>
                            </form>
                        </div>
                    </div>
                </div>
